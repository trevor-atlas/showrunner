...
/**
 * The live feed (spec §16.7/§16.10): folded daemon events (types 1–12, §6)
...
/**
 * Typed rendering per event type (§6 #1–12). One row: clock time + glyph +
...
/**
 * The naming rule for tool calls (spec §6): name the row the way you'd read
