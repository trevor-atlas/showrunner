...
import { warmEntryAssets } from '../actions/document.tsx'

export function render() {
  return renderWith(
    ({ request, router }) =>
      async function render(node: RemixNode, init?: ResponseInit) {
        // Resolve the document entry script's href/preloads before the SSR tree
        // walk (which is synchronous) so `Document` can render them inline.
