...
import type { ScriptMap } from "../../daemon/src/runner.ts";
import { cursorEvents, listPhases, openDb, resolveScriptedSessions, runBlueprint } from "../../daemon/src/index.ts";

import promptBlueprint from "../src/blueprints/prompt.ts";
import scoutBlueprint from "../src/blueprints/scout.ts";
import planBlueprint from "../src/blueprints/plan.ts";
import buildBlueprint from "../src/blueprints/build.ts";
import planBuildBlueprint from "../src/blueprints/plan_build.ts";
import buildTestBlueprint from "../src/blueprints/build_test.ts";
import buildReviewBlueprint from "../src/blueprints/build_review.ts";
import planBuildTestBlueprint from "../src/blueprints/plan_build_test.ts";
import documentBlueprint from "../src/blueprints/document.ts";
import everythingBlueprint from "../src/blueprints/everything.ts";
...
import type { Blueprint } from "@showrunner/core";
...
test("every blueprint phase resolves a scripted FakePi session for the CLI path (src/blueprints/fake-pi)", () => {
  const blueprints = [
    promptBlueprint,
    scoutBlueprint,
    planBlueprint,
  ...
  const fakePiDir = join(import.meta.dir, "..", "src", "blueprints", "fake-pi");
