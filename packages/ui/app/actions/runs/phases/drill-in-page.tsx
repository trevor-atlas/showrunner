...
import type { GateResultWithOverride, PhaseRow } from "../../../../../daemon/src/db.ts";
import type { RawTail } from "../../../../../daemon/src/client.ts";
...
export function DrillInPage(handle: Handle<DrillInPageProps>) {
  return () => {
    const { runId, run, phase, snapshotPhase, snapshotModuleDir, envelopes, gates, spend, raw, daemonDown, daemonAddress } =
      handle.props;
